...
![T2 Thermostat USB Adaptor Parts](images/1.jpg)
 ...
 - The case is 3D printed. The case folder contains the 3mf files that can were 3D printed. I tried PLA+ and PETG filaments. Both worked but the spring clip worked better using PETG filament.
...
The T2 thermostat can then be powered from the USB C connector.
